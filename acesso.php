...
if (isset($_SESSION['id'])) {
    ...
    if(isset($resultado)){
        if ($_SESSION['token'] == $resultado['token']){
            echo "<script>window.location = 'acesso2.php'</script>";
            exit;
        } else {
        ...
        <div class="devedor">
            <div class="box1">
                <form action="acessoLogin.php" method="post">
                    ...
                    if (isset($_GET["erro"])) {
                        if ($_GET['erro'] == "true"){
                            echo '<div style="color:orange;">E-mail ou Senha incorreto</div><br><br>';
                        }
                    }
                    ?>
                    <input class="input--black" type="email" name="email" id="" required placeholder="E-mail">
                    <br>
                    <br>
                    <input class="input--black" type="password" name="password" required id="" placeholder="Senha">
                    <br>
                    <br>
