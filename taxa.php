                    ...
                    if(isset($resultado)){
                        ...
                        echo '
                            ...
                            <li class="nav__item dropdown">
                                ...
                                <div class="dropdown-content">
                                    <a href="taxa.php" class="active-l">TAXA</a>
        ...
        <div class="devedor">
            <div class="box1">
                <div>
                    ...
                    <input class="input--black" onfocusout="valorS()" onkeypress="return onlynumber();" type="text"
                        id="devedor" placeholder="Saldo devedor">
                    <input class="input--black" onfocusout="valorN()" onkeypress="return onlynumber();" type="text"
                        id="parcela" placeholder="N° de parcela">
