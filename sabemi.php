...
<head>
    ...
    <script src="/js/sabemi.js"></script>
                        ...
                        echo '
                            ...
                            <li class="nav__item dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <a href="sabemi.php" class="active-l">SABEMI</a>
            ...
            <div class="box1">
                <div>
                    ...
                    <div class="dropdownOption">
                        <div class="dropBox" onmouseup="dropSelect()"><p>45%</p> <i class="fa-active fa-caret-down"></i></div>
                        <div class="dropdownOption-content">
                            <div onmouseup="dropSelectSend(45)">45%</div>
                            <div onmouseup="dropSelectSend(48)">48%</div>
                        </div>
                    </div>
