...
<head>
    ...
    <script src="/js/devedor.js"></script>
        ...
        <nav class="nav container">
            ...
            <div class="nav__menu" id="nav-menu">
                ...
                if(isset($resultado)){
                    ...
                    echo '
                        <li class="nav__item">
                            <a href="devedor.php" class="nav__link active-link">Saldo devedor</a>
                        </li>
        ...
        <div class="devedor">
            <div class="box1">
                <div>
                    ...
                    <input class="input--black" onkeypress="return onlynumber();" type="text" id="parcela"
                        placeholder="N° de parcela">
                    <div class="dropdownOption">
                        <div class="dropBox" onmouseup="dropSelect()">
                            <p>35%</p> <i class="fa-active fa-caret-down"></i>
                        </div>
                        <div class="dropdownOption-content">
                            <div onmouseup="dropSelectSend(35)">35%</div>
                            <div onmouseup="dropSelectSend(38)">38%</div>
                            <div onmouseup="dropSelectSend(40)">40%</div>
                        </div>
                    </div>
